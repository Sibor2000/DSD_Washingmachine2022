...
HD_PWD='E:/info/I-2/DSD/washingmachine/washingmachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RobertComp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RobertComp.tcl -notrace
