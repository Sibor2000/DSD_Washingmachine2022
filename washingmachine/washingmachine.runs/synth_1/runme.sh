...
HD_PWD='E:/info/I-2/DSD/washingmachine/washingmachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RobertComp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RobertComp.tcl
